          ...
          <div className={styles.top}>
            <div className={styles.header}>
              <Link to="/">
                ...
                <span className={styles.title}>FLX MS</span>
              </Link>
            </div>
            <div className={styles.desc}>Fujifilm LX Management System</div>
          </div>
          {children}
        </div>
        <DefaultFooter
